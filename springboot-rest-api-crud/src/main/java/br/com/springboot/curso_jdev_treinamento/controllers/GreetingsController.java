...
public class GreetingsController {
    ...
    @ResponseBody /*Descrição da resposta*/
    public ResponseEntity<List<Usuario>> findByName (@RequestParam(name = "name") String name){/*Notação para parametros*/
    ...
    public ResponseEntity<?> update (@RequestBody Usuario user){
    	...
    	if( user.getId() != null && validUser(user.getId())) {
    ...
    private boolean validUser(Long id) {
    	boolean valid = false;
